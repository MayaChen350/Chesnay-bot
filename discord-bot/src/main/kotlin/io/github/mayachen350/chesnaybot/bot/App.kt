...
import io.github.mayachen350.chesnaybot.bot.features.command.handler.moderationCommands
import io.github.mayachen350.chesnaybot.bot.features.event.handler.roleMessageListeners
...
fun main(): Unit = runBlocking {
    ...
    println("BOT STATUS SET TO ${BotStatusHandler.statusBehavior}")
