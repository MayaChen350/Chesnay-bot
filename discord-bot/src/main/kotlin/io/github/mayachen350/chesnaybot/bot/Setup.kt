...
import io.github.mayachen350.chesnaybot.bot.backend.RolesGivenToMemberEntity
import io.github.mayachen350.chesnaybot.bot.backend.RolesGivenToMemberTable
import io.github.mayachen350.chesnaybot.bot.backend.ValetService
import io.github.mayachen350.chesnaybot.bot.features.event.logic.dreamhouseEmbedLogDefault
...
import io.github.mayachen350.chesnaybot.bot.features.system.roleChannel.RoleChannelDispenser
import io.github.mayachen350.chesnaybot.bot.features.utils.ReactionSimple
import io.github.mayachen350.chesnaybot.bot.utils.toSnowflake
        ...
        if (member != null) {
            ...
            val hasNoCorrespondingReaction: Boolean = reactions.none {
                roleFound = withContext(Dispatchers.Default) {
                    RoleChannelDispenser.Companion.findRoleFromEmoji(
                        it.message.content,
                        it.reaction.emoji
                    )
                }
